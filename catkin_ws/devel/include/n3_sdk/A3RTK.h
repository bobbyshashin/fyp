// Generated by gencpp from file n3_sdk/A3RTK.msg
// DO NOT EDIT!


#ifndef N3_SDK_MESSAGE_A3RTK_H
#define N3_SDK_MESSAGE_A3RTK_H
...
struct A3RTK_
{
  ...
  typedef boost::shared_ptr< ::n3_sdk::A3RTK_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::n3_sdk::A3RTK_<ContainerAllocator> const> ConstPtr;

}; // struct A3RTK_

typedef ::n3_sdk::A3RTK_<std::allocator<void> > A3RTK;

typedef boost::shared_ptr< ::n3_sdk::A3RTK > A3RTKPtr;
typedef boost::shared_ptr< ::n3_sdk::A3RTK const> A3RTKConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::n3_sdk::A3RTK_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::n3_sdk::A3RTK_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::n3_sdk::A3RTK_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::n3_sdk::A3RTK_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::n3_sdk::A3RTK_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::n3_sdk::A3RTK_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::n3_sdk::A3RTK_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::n3_sdk::A3RTK_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::n3_sdk::A3RTK_<ContainerAllocator> >
{
  ...
  static const char* value(const ::n3_sdk::A3RTK_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x2f1a4c1310d587c3ULL;
  static const uint64_t static_value2 = 0xf79f00f74019a0beULL;
};

template<class ContainerAllocator>
struct DataType< ::n3_sdk::A3RTK_<ContainerAllocator> >
{
  static const char* value()
  {
    return "n3_sdk/A3RTK";
...
template<class ContainerAllocator>
struct Definition< ::n3_sdk::A3RTK_<ContainerAllocator> >
{
  static const char* value()
  {
    return "uint32 date\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::n3_sdk::A3RTK_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::n3_sdk::A3RTK_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::n3_sdk::A3RTK_<ContainerAllocator>& v)
  {
    s << indent << "date: ";
