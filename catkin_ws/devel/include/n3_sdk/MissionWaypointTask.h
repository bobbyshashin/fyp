// Generated by gencpp from file n3_sdk/MissionWaypointTask.msg
// DO NOT EDIT!


#ifndef N3_SDK_MESSAGE_MISSIONWAYPOINTTASK_H
#define N3_SDK_MESSAGE_MISSIONWAYPOINTTASK_H
...
#include <n3_sdk/MissionWaypoint.h>
...
struct MissionWaypointTask_
{
  ...
  _gimbal_pitch_mode_type gimbal_pitch_mode;
   ...
   typedef std::vector< ::n3_sdk::MissionWaypoint_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::n3_sdk::MissionWaypoint_<ContainerAllocator> >::other >  _mission_waypoint_type;
  _mission_waypoint_type mission_waypoint;




  typedef boost::shared_ptr< ::n3_sdk::MissionWaypointTask_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::n3_sdk::MissionWaypointTask_<ContainerAllocator> const> ConstPtr;

}; // struct MissionWaypointTask_

typedef ::n3_sdk::MissionWaypointTask_<std::allocator<void> > MissionWaypointTask;

typedef boost::shared_ptr< ::n3_sdk::MissionWaypointTask > MissionWaypointTaskPtr;
typedef boost::shared_ptr< ::n3_sdk::MissionWaypointTask const> MissionWaypointTaskConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::n3_sdk::MissionWaypointTask_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::n3_sdk::MissionWaypointTask_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::n3_sdk::MissionWaypointTask_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::n3_sdk::MissionWaypointTask_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::n3_sdk::MissionWaypointTask_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::n3_sdk::MissionWaypointTask_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::n3_sdk::MissionWaypointTask_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::n3_sdk::MissionWaypointTask_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::n3_sdk::MissionWaypointTask_<ContainerAllocator> >
{
  ...
  static const char* value(const ::n3_sdk::MissionWaypointTask_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa81a8c039337b422ULL;
  static const uint64_t static_value2 = 0xbde8ccc87d96c14bULL;
};

template<class ContainerAllocator>
struct DataType< ::n3_sdk::MissionWaypointTask_<ContainerAllocator> >
{
  static const char* value()
  {
    return "n3_sdk/MissionWaypointTask";
  }
...
template<class ContainerAllocator>
struct Definition< ::n3_sdk::MissionWaypointTask_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::n3_sdk::MissionWaypointTask_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::n3_sdk::MissionWaypointTask_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::n3_sdk::MissionWaypointTask_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.mission_waypoint.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::n3_sdk::MissionWaypoint_<ContainerAllocator> >::stream(s, indent + "    ", v.mission_waypoint[i]);
    }
  }
};
...
#endif // N3_SDK_MESSAGE_MISSIONWAYPOINTTASK_H
