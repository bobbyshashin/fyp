...
"""autogenerated by genpy from n3_sdk/MissionWpDownloadRequest.msg. Do not edit."""
import sys
...
class MissionWpDownloadRequest(genpy.Message):
  ...
  _type = "n3_sdk/MissionWpDownloadRequest"
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from n3_sdk/MissionWpDownloadResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class MissionWpDownloadResponse(genpy.Message):
  ...
  _type = "n3_sdk/MissionWpDownloadResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  _slot_types = ['n3_sdk/MissionWaypointTask']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.waypoint_task is None:
        self.waypoint_task = n3_sdk.msg.MissionWaypointTask()
    else:
      self.waypoint_task = n3_sdk.msg.MissionWaypointTask()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = n3_sdk.msg.MissionWaypoint()
        _x = val1
        start = end
        end += 32
...
class MissionWpDownload(object):
  _type          = 'n3_sdk/MissionWpDownload'
  _md5sum = '7c965e82a72d204e1e6d1e75389efb89'
