...
"""autogenerated by genpy from n3_sdk/MissionWaypoint.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['float64','float64','float32','float32','int16','int16','uint8','uint8','uint16','n3_sdk/MissionWaypointAction']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.waypoint_action is None:
        self.waypoint_action = n3_sdk.msg.MissionWaypointAction()
    else:
      self.latitude = 0.
      self.longitude = 0.
      self.altitude = 0.
