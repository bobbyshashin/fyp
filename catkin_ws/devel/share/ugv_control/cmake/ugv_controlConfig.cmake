...
if("TRUE" STREQUAL "TRUE")
  set(ugv_control_SOURCE_PREFIX /home/ubuntu/fyp/catkin_ws/src/ugv/ugv_control)
  set(ugv_control_DEVEL_PREFIX /home/ubuntu/fyp/catkin_ws/devel)
  ...
  set(ugv_control_INSTALL_PREFIX /home/ubuntu/fyp/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ugv_control' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ubuntu <ubuntu@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ugv_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/fyp/catkin_ws/src/ugv/ugv_control/${idir}'.  Ask the maintainer 'ubuntu <ubuntu@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${ugv_control_dep}_FOUND)
      find_package(${ugv_control_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ugv_control_dep} REQUIRED ${depend_list})
  endif()
