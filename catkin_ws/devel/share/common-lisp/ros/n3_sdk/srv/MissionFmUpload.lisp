...
(cl:defclass <MissionFmUpload-request> (roslisp-msg-protocol:ros-message)
  ((followme_task
    ...
    :type n3_sdk-msg:MissionFollowmeTask
    :initform (cl:make-instance 'n3_sdk-msg:MissionFollowmeTask)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MissionFmUpload-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionFmUpload-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<MissionFmUpload-request> is deprecated: use n3_sdk-srv:MissionFmUpload-request instead.")))

(cl:ensure-generic-function 'followme_task-val :lambda-list '(m))
(cl:defmethod followme_task-val ((m <MissionFmUpload-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:followme_task-val is deprecated.  Use n3_sdk-srv:followme_task instead.")
  (followme_task m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MissionFmUpload-request>)))
  ...
  (cl:format cl:nil "MissionFollowmeTask followme_task~%~%================================================================================~%MSG: n3_sdk/MissionFollowmeTask~%uint8 mode~%uint8 yaw_mode~%float64 initial_latitude~%float64 initial_longitude~%uint16 initial_altitude~%uint8 sensitivity~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MissionFmUpload-request)))
  "Returns full string definition for message of type 'MissionFmUpload-request"
  (cl:format cl:nil "MissionFollowmeTask followme_task~%~%================================================================================~%MSG: n3_sdk/MissionFollowmeTask~%uint8 mode~%uint8 yaw_mode~%float64 initial_latitude~%float64 initial_longitude~%uint16 initial_altitude~%uint8 sensitivity~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <MissionFmUpload-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionFmUpload-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<MissionFmUpload-response> is deprecated: use n3_sdk-srv:MissionFmUpload-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MissionFmUpload-response>)))
  ...
  "n3_sdk/MissionFmUploadResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MissionFmUpload-response)))
  "Returns string type for a service object of type 'MissionFmUpload-response"
  "n3_sdk/MissionFmUploadResponse")
