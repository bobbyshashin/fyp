...
(cl:defmethod cl:initialize-instance :after ((m <VersionCheck-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VersionCheck-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<VersionCheck-request> is deprecated: use n3_sdk-srv:VersionCheck-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <VersionCheck-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VersionCheck-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<VersionCheck-response> is deprecated: use n3_sdk-srv:VersionCheck-response instead.")))
