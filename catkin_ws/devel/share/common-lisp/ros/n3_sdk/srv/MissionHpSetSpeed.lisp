...
(cl:defmethod cl:initialize-instance :after ((m <MissionHpSetSpeed-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionHpSetSpeed-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<MissionHpSetSpeed-request> is deprecated: use n3_sdk-srv:MissionHpSetSpeed-request instead.")))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <MissionHpSetSpeed-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:speed-val is deprecated.  Use n3_sdk-srv:speed instead.")
  (speed m))

(cl:ensure-generic-function 'direction-val :lambda-list '(m))
(cl:defmethod direction-val ((m <MissionHpSetSpeed-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:direction-val is deprecated.  Use n3_sdk-srv:direction instead.")
  (direction m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MissionHpSetSpeed-request>)))
  ...
  "n3_sdk/MissionHpSetSpeedRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MissionHpSetSpeed-request)))
  "Returns string type for a service object of type 'MissionHpSetSpeed-request"
  "n3_sdk/MissionHpSetSpeedRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <MissionHpSetSpeed-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionHpSetSpeed-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<MissionHpSetSpeed-response> is deprecated: use n3_sdk-srv:MissionHpSetSpeed-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MissionHpSetSpeed-response>)))
  ...
  "n3_sdk/MissionHpSetSpeedResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MissionHpSetSpeed-response)))
  "Returns string type for a service object of type 'MissionHpSetSpeed-response"
  "n3_sdk/MissionHpSetSpeedResponse")
