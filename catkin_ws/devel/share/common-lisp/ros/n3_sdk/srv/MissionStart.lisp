...
(cl:defmethod cl:initialize-instance :after ((m <MissionStart-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionStart-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<MissionStart-request> is deprecated: use n3_sdk-srv:MissionStart-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <MissionStart-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionStart-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<MissionStart-response> is deprecated: use n3_sdk-srv:MissionStart-response instead.")))
