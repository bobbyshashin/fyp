...
(cl:defmethod cl:initialize-instance :after ((m <GimbalSpeedControl-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GimbalSpeedControl-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<GimbalSpeedControl-request> is deprecated: use n3_sdk-srv:GimbalSpeedControl-request instead.")))

(cl:ensure-generic-function 'yaw_rate-val :lambda-list '(m))
(cl:defmethod yaw_rate-val ((m <GimbalSpeedControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:yaw_rate-val is deprecated.  Use n3_sdk-srv:yaw_rate instead.")
  (yaw_rate m))

(cl:ensure-generic-function 'roll_rate-val :lambda-list '(m))
(cl:defmethod roll_rate-val ((m <GimbalSpeedControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:roll_rate-val is deprecated.  Use n3_sdk-srv:roll_rate instead.")
  (roll_rate m))

(cl:ensure-generic-function 'pitch_rate-val :lambda-list '(m))
(cl:defmethod pitch_rate-val ((m <GimbalSpeedControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:pitch_rate-val is deprecated.  Use n3_sdk-srv:pitch_rate instead.")
  (pitch_rate m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GimbalSpeedControl-request>)))
  ...
  "n3_sdk/GimbalSpeedControlRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GimbalSpeedControl-request)))
  "Returns string type for a service object of type 'GimbalSpeedControl-request"
  "n3_sdk/GimbalSpeedControlRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GimbalSpeedControl-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GimbalSpeedControl-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<GimbalSpeedControl-response> is deprecated: use n3_sdk-srv:GimbalSpeedControl-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GimbalSpeedControl-response>)))
  ...
  "n3_sdk/GimbalSpeedControlResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GimbalSpeedControl-response)))
  "Returns string type for a service object of type 'GimbalSpeedControl-response"
  "n3_sdk/GimbalSpeedControlResponse")
