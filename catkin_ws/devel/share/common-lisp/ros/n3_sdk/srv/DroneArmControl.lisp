...
(cl:defmethod cl:initialize-instance :after ((m <DroneArmControl-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DroneArmControl-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<DroneArmControl-request> is deprecated: use n3_sdk-srv:DroneArmControl-request instead.")))

(cl:ensure-generic-function 'arm-val :lambda-list '(m))
(cl:defmethod arm-val ((m <DroneArmControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:arm-val is deprecated.  Use n3_sdk-srv:arm instead.")
  (arm m))
...
(cl:defmethod cl:initialize-instance :after ((m <DroneArmControl-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DroneArmControl-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<DroneArmControl-response> is deprecated: use n3_sdk-srv:DroneArmControl-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DroneArmControl-response>)))
  ...
  "n3_sdk/DroneArmControlResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DroneArmControl-response)))
  "Returns string type for a service object of type 'DroneArmControl-response"
  "n3_sdk/DroneArmControlResponse")
