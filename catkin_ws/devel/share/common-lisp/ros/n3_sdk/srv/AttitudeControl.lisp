...
(cl:defmethod cl:initialize-instance :after ((m <AttitudeControl-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AttitudeControl-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<AttitudeControl-request> is deprecated: use n3_sdk-srv:AttitudeControl-request instead.")))

(cl:ensure-generic-function 'flag-val :lambda-list '(m))
(cl:defmethod flag-val ((m <AttitudeControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:flag-val is deprecated.  Use n3_sdk-srv:flag instead.")
  (flag m))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <AttitudeControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:x-val is deprecated.  Use n3_sdk-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <AttitudeControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:y-val is deprecated.  Use n3_sdk-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <AttitudeControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:z-val is deprecated.  Use n3_sdk-srv:z instead.")
  (z m))
...
(cl:defmethod cl:initialize-instance :after ((m <AttitudeControl-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AttitudeControl-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<AttitudeControl-response> is deprecated: use n3_sdk-srv:AttitudeControl-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AttitudeControl-response>)))
  ...
  "n3_sdk/AttitudeControlResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AttitudeControl-response)))
  "Returns string type for a service object of type 'AttitudeControl-response"
  "n3_sdk/AttitudeControlResponse")
