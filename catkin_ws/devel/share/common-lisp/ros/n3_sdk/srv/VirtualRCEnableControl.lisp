...
(cl:defmethod cl:initialize-instance :after ((m <VirtualRCEnableControl-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VirtualRCEnableControl-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<VirtualRCEnableControl-request> is deprecated: use n3_sdk-srv:VirtualRCEnableControl-request instead.")))

(cl:ensure-generic-function 'enable-val :lambda-list '(m))
(cl:defmethod enable-val ((m <VirtualRCEnableControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:enable-val is deprecated.  Use n3_sdk-srv:enable instead.")
  (enable m))
...
(cl:defmethod if_back_to_real-val ((m <VirtualRCEnableControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:if_back_to_real-val is deprecated.  Use n3_sdk-srv:if_back_to_real instead.")
  (if_back_to_real m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<VirtualRCEnableControl-request>)))
  ...
  "n3_sdk/VirtualRCEnableControlRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'VirtualRCEnableControl-request)))
  "Returns string type for a service object of type 'VirtualRCEnableControl-request"
  "n3_sdk/VirtualRCEnableControlRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <VirtualRCEnableControl-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VirtualRCEnableControl-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<VirtualRCEnableControl-response> is deprecated: use n3_sdk-srv:VirtualRCEnableControl-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<VirtualRCEnableControl-response>)))
  ...
  "n3_sdk/VirtualRCEnableControlResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'VirtualRCEnableControl-response)))
  "Returns string type for a service object of type 'VirtualRCEnableControl-response"
  "n3_sdk/VirtualRCEnableControlResponse")
