...
(cl:defmethod cl:initialize-instance :after ((m <GimbalAngleControl-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GimbalAngleControl-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<GimbalAngleControl-request> is deprecated: use n3_sdk-srv:GimbalAngleControl-request instead.")))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <GimbalAngleControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:yaw-val is deprecated.  Use n3_sdk-srv:yaw instead.")
  (yaw m))

(cl:ensure-generic-function 'roll-val :lambda-list '(m))
(cl:defmethod roll-val ((m <GimbalAngleControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:roll-val is deprecated.  Use n3_sdk-srv:roll instead.")
  (roll m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <GimbalAngleControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:pitch-val is deprecated.  Use n3_sdk-srv:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'duration-val :lambda-list '(m))
(cl:defmethod duration-val ((m <GimbalAngleControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:duration-val is deprecated.  Use n3_sdk-srv:duration instead.")
  (duration m))
...
(cl:defmethod absolute_or_incremental-val ((m <GimbalAngleControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:absolute_or_incremental-val is deprecated.  Use n3_sdk-srv:absolute_or_incremental instead.")
...
(cl:defmethod yaw_cmd_ignore-val ((m <GimbalAngleControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:yaw_cmd_ignore-val is deprecated.  Use n3_sdk-srv:yaw_cmd_ignore instead.")
  (yaw_cmd_ignore m))
...
(cl:defmethod roll_cmd_ignore-val ((m <GimbalAngleControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:roll_cmd_ignore-val is deprecated.  Use n3_sdk-srv:roll_cmd_ignore instead.")
  (roll_cmd_ignore m))
...
(cl:defmethod pitch_cmd_ignore-val ((m <GimbalAngleControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:pitch_cmd_ignore-val is deprecated.  Use n3_sdk-srv:pitch_cmd_ignore instead.")
  (pitch_cmd_ignore m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GimbalAngleControl-request>)))
  ...
  "n3_sdk/GimbalAngleControlRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GimbalAngleControl-request)))
  "Returns string type for a service object of type 'GimbalAngleControl-request"
  "n3_sdk/GimbalAngleControlRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GimbalAngleControl-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GimbalAngleControl-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<GimbalAngleControl-response> is deprecated: use n3_sdk-srv:GimbalAngleControl-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GimbalAngleControl-response>)))
  ...
  "n3_sdk/GimbalAngleControlResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GimbalAngleControl-response)))
  "Returns string type for a service object of type 'GimbalAngleControl-response"
  "n3_sdk/GimbalAngleControlResponse")
