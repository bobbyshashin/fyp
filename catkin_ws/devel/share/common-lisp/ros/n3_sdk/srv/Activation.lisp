...
(cl:defmethod cl:initialize-instance :after ((m <Activation-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Activation-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<Activation-request> is deprecated: use n3_sdk-srv:Activation-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Activation-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Activation-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<Activation-response> is deprecated: use n3_sdk-srv:Activation-response instead.")))
