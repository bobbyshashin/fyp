...
(cl:defmethod cl:initialize-instance :after ((m <VelocityControl-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VelocityControl-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<VelocityControl-request> is deprecated: use n3_sdk-srv:VelocityControl-request instead.")))

(cl:ensure-generic-function 'frame-val :lambda-list '(m))
(cl:defmethod frame-val ((m <VelocityControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:frame-val is deprecated.  Use n3_sdk-srv:frame instead.")
  (frame m))

(cl:ensure-generic-function 'vx-val :lambda-list '(m))
(cl:defmethod vx-val ((m <VelocityControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:vx-val is deprecated.  Use n3_sdk-srv:vx instead.")
  (vx m))

(cl:ensure-generic-function 'vy-val :lambda-list '(m))
(cl:defmethod vy-val ((m <VelocityControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:vy-val is deprecated.  Use n3_sdk-srv:vy instead.")
  (vy m))

(cl:ensure-generic-function 'vz-val :lambda-list '(m))
(cl:defmethod vz-val ((m <VelocityControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:vz-val is deprecated.  Use n3_sdk-srv:vz instead.")
  (vz m))

(cl:ensure-generic-function 'yawRate-val :lambda-list '(m))
(cl:defmethod yawRate-val ((m <VelocityControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:yawRate-val is deprecated.  Use n3_sdk-srv:yawRate instead.")
  (yawRate m))
...
(cl:defmethod cl:initialize-instance :after ((m <VelocityControl-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VelocityControl-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<VelocityControl-response> is deprecated: use n3_sdk-srv:VelocityControl-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<VelocityControl-response>)))
  ...
  "n3_sdk/VelocityControlResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'VelocityControl-response)))
  "Returns string type for a service object of type 'VelocityControl-response"
  "n3_sdk/VelocityControlResponse")
