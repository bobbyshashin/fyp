...
(cl:defmethod cl:initialize-instance :after ((m <GlobalPositionControl-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GlobalPositionControl-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<GlobalPositionControl-request> is deprecated: use n3_sdk-srv:GlobalPositionControl-request instead.")))

(cl:ensure-generic-function 'latitude-val :lambda-list '(m))
(cl:defmethod latitude-val ((m <GlobalPositionControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:latitude-val is deprecated.  Use n3_sdk-srv:latitude instead.")
  (latitude m))

(cl:ensure-generic-function 'longitude-val :lambda-list '(m))
(cl:defmethod longitude-val ((m <GlobalPositionControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:longitude-val is deprecated.  Use n3_sdk-srv:longitude instead.")
  (longitude m))

(cl:ensure-generic-function 'altitude-val :lambda-list '(m))
(cl:defmethod altitude-val ((m <GlobalPositionControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:altitude-val is deprecated.  Use n3_sdk-srv:altitude instead.")
  (altitude m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GlobalPositionControl-request>)))
  ...
  "n3_sdk/GlobalPositionControlRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GlobalPositionControl-request)))
  "Returns string type for a service object of type 'GlobalPositionControl-request"
  "n3_sdk/GlobalPositionControlRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GlobalPositionControl-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GlobalPositionControl-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<GlobalPositionControl-response> is deprecated: use n3_sdk-srv:GlobalPositionControl-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GlobalPositionControl-response>)))
  ...
  "n3_sdk/GlobalPositionControlResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GlobalPositionControl-response)))
  "Returns string type for a service object of type 'GlobalPositionControl-response"
  "n3_sdk/GlobalPositionControlResponse")
