...
(cl:defmethod cl:initialize-instance :after ((m <MissionPause-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionPause-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<MissionPause-request> is deprecated: use n3_sdk-srv:MissionPause-request instead.")))

(cl:ensure-generic-function 'pause-val :lambda-list '(m))
(cl:defmethod pause-val ((m <MissionPause-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-srv:pause-val is deprecated.  Use n3_sdk-srv:pause instead.")
  (pause m))
...
(cl:defmethod cl:initialize-instance :after ((m <MissionPause-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionPause-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<MissionPause-response> is deprecated: use n3_sdk-srv:MissionPause-response instead.")))
