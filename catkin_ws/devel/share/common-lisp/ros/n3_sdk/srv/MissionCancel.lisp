...
(cl:defmethod cl:initialize-instance :after ((m <MissionCancel-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionCancel-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<MissionCancel-request> is deprecated: use n3_sdk-srv:MissionCancel-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <MissionCancel-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionCancel-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-srv:<MissionCancel-response> is deprecated: use n3_sdk-srv:MissionCancel-response instead.")))
