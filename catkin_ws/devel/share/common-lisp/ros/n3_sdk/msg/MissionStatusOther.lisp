...
(cl:defmethod cl:initialize-instance :after ((m <MissionStatusOther>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionStatusOther)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-msg:<MissionStatusOther> is deprecated: use n3_sdk-msg:MissionStatusOther instead.")))
...
(cl:defmethod last_mission_type-val ((m <MissionStatusOther>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:last_mission_type-val is deprecated.  Use n3_sdk-msg:last_mission_type instead.")
  (last_mission_type m))

(cl:ensure-generic-function 'is_broken-val :lambda-list '(m))
(cl:defmethod is_broken-val ((m <MissionStatusOther>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:is_broken-val is deprecated.  Use n3_sdk-msg:is_broken instead.")
  (is_broken m))
