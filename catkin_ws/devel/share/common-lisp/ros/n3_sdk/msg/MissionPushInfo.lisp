...
(cl:defmethod cl:initialize-instance :after ((m <MissionPushInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionPushInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-msg:<MissionPushInfo> is deprecated: use n3_sdk-msg:MissionPushInfo instead.")))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <MissionPushInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:type-val is deprecated.  Use n3_sdk-msg:type instead.")
  (type m))

(cl:ensure-generic-function 'data_1-val :lambda-list '(m))
(cl:defmethod data_1-val ((m <MissionPushInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:data_1-val is deprecated.  Use n3_sdk-msg:data_1 instead.")
  (data_1 m))

(cl:ensure-generic-function 'data_2-val :lambda-list '(m))
(cl:defmethod data_2-val ((m <MissionPushInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:data_2-val is deprecated.  Use n3_sdk-msg:data_2 instead.")
  (data_2 m))

(cl:ensure-generic-function 'data_3-val :lambda-list '(m))
(cl:defmethod data_3-val ((m <MissionPushInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:data_3-val is deprecated.  Use n3_sdk-msg:data_3 instead.")
  (data_3 m))

(cl:ensure-generic-function 'data_4-val :lambda-list '(m))
(cl:defmethod data_4-val ((m <MissionPushInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:data_4-val is deprecated.  Use n3_sdk-msg:data_4 instead.")
  (data_4 m))

(cl:ensure-generic-function 'data_5-val :lambda-list '(m))
(cl:defmethod data_5-val ((m <MissionPushInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:data_5-val is deprecated.  Use n3_sdk-msg:data_5 instead.")
  (data_5 m))
