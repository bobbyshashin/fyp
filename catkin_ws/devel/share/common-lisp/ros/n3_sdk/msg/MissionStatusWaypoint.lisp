...
(cl:defmethod cl:initialize-instance :after ((m <MissionStatusWaypoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionStatusWaypoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-msg:<MissionStatusWaypoint> is deprecated: use n3_sdk-msg:MissionStatusWaypoint instead.")))
...
(cl:defmethod target_waypoint-val ((m <MissionStatusWaypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:target_waypoint-val is deprecated.  Use n3_sdk-msg:target_waypoint instead.")
  (target_waypoint m))

(cl:ensure-generic-function 'current_status-val :lambda-list '(m))
(cl:defmethod current_status-val ((m <MissionStatusWaypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:current_status-val is deprecated.  Use n3_sdk-msg:current_status instead.")
  (current_status m))
