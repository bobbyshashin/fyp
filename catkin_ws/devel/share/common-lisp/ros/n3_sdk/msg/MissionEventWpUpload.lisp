...
(cl:defmethod cl:initialize-instance :after ((m <MissionEventWpUpload>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionEventWpUpload)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-msg:<MissionEventWpUpload> is deprecated: use n3_sdk-msg:MissionEventWpUpload instead.")))

(cl:ensure-generic-function 'incident_type-val :lambda-list '(m))
(cl:defmethod incident_type-val ((m <MissionEventWpUpload>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:incident_type-val is deprecated.  Use n3_sdk-msg:incident_type instead.")
  (incident_type m))

(cl:ensure-generic-function 'mission_valid-val :lambda-list '(m))
(cl:defmethod mission_valid-val ((m <MissionEventWpUpload>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:mission_valid-val is deprecated.  Use n3_sdk-msg:mission_valid instead.")
  (mission_valid m))

(cl:ensure-generic-function 'estimated_runtime-val :lambda-list '(m))
(cl:defmethod estimated_runtime-val ((m <MissionEventWpUpload>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:estimated_runtime-val is deprecated.  Use n3_sdk-msg:estimated_runtime instead.")
  (estimated_runtime m))
