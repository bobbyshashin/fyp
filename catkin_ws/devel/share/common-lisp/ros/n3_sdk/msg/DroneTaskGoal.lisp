...
(cl:defmethod cl:initialize-instance :after ((m <DroneTaskGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DroneTaskGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-msg:<DroneTaskGoal> is deprecated: use n3_sdk-msg:DroneTaskGoal instead.")))

(cl:ensure-generic-function 'task-val :lambda-list '(m))
(cl:defmethod task-val ((m <DroneTaskGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:task-val is deprecated.  Use n3_sdk-msg:task instead.")
  (task m))
