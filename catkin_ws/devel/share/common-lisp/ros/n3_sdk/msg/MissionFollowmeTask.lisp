...
(cl:defmethod cl:initialize-instance :after ((m <MissionFollowmeTask>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionFollowmeTask)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-msg:<MissionFollowmeTask> is deprecated: use n3_sdk-msg:MissionFollowmeTask instead.")))
...
(cl:defmethod initial_latitude-val ((m <MissionFollowmeTask>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:initial_latitude-val is deprecated.  Use n3_sdk-msg:initial_latitude instead.")
  (initial_latitude m))

(cl:ensure-generic-function 'initial_longitude-val :lambda-list '(m))
(cl:defmethod initial_longitude-val ((m <MissionFollowmeTask>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:initial_longitude-val is deprecated.  Use n3_sdk-msg:initial_longitude instead.")
  (initial_longitude m))

(cl:ensure-generic-function 'initial_altitude-val :lambda-list '(m))
(cl:defmethod initial_altitude-val ((m <MissionFollowmeTask>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:initial_altitude-val is deprecated.  Use n3_sdk-msg:initial_altitude instead.")
  (initial_altitude m))

(cl:ensure-generic-function 'sensitivity-val :lambda-list '(m))
(cl:defmethod sensitivity-val ((m <MissionFollowmeTask>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:sensitivity-val is deprecated.  Use n3_sdk-msg:sensitivity instead.")
  (sensitivity m))
