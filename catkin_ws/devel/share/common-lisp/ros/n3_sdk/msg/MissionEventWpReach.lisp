...
(cl:defmethod cl:initialize-instance :after ((m <MissionEventWpReach>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionEventWpReach)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-msg:<MissionEventWpReach> is deprecated: use n3_sdk-msg:MissionEventWpReach instead.")))
...
(cl:defmethod waypoint_index-val ((m <MissionEventWpReach>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:waypoint_index-val is deprecated.  Use n3_sdk-msg:waypoint_index instead.")
  (waypoint_index m))
