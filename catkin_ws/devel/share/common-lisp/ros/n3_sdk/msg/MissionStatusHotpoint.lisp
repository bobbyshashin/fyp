...
(cl:defmethod cl:initialize-instance :after ((m <MissionStatusHotpoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionStatusHotpoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-msg:<MissionStatusHotpoint> is deprecated: use n3_sdk-msg:MissionStatusHotpoint instead.")))

(cl:ensure-generic-function 'mission_type-val :lambda-list '(m))
(cl:defmethod mission_type-val ((m <MissionStatusHotpoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:mission_type-val is deprecated.  Use n3_sdk-msg:mission_type instead.")
  (mission_type m))

(cl:ensure-generic-function 'mission_status-val :lambda-list '(m))
(cl:defmethod mission_status-val ((m <MissionStatusHotpoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:mission_status-val is deprecated.  Use n3_sdk-msg:mission_status instead.")
  (mission_status m))

(cl:ensure-generic-function 'hotpoint_radius-val :lambda-list '(m))
(cl:defmethod hotpoint_radius-val ((m <MissionStatusHotpoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:hotpoint_radius-val is deprecated.  Use n3_sdk-msg:hotpoint_radius instead.")
  (hotpoint_radius m))

(cl:ensure-generic-function 'error_code-val :lambda-list '(m))
(cl:defmethod error_code-val ((m <MissionStatusHotpoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:error_code-val is deprecated.  Use n3_sdk-msg:error_code instead.")
  (error_code m))

(cl:ensure-generic-function 'hotpoint_velocity-val :lambda-list '(m))
(cl:defmethod hotpoint_velocity-val ((m <MissionStatusHotpoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:hotpoint_velocity-val is deprecated.  Use n3_sdk-msg:hotpoint_velocity instead.")
  (hotpoint_velocity m))
