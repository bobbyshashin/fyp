...
(cl:defmethod cl:initialize-instance :after ((m <PowerStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PowerStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-msg:<PowerStatus> is deprecated: use n3_sdk-msg:PowerStatus instead.")))

(cl:ensure-generic-function 'percentage-val :lambda-list '(m))
(cl:defmethod percentage-val ((m <PowerStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:percentage-val is deprecated.  Use n3_sdk-msg:percentage instead.")
  (percentage m))
