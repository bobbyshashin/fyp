...
(cl:defmethod cl:initialize-instance :after ((m <MissionEventWpAction>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionEventWpAction)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-msg:<MissionEventWpAction> is deprecated: use n3_sdk-msg:MissionEventWpAction instead.")))
...
(cl:defmethod repeat-val ((m <MissionEventWpAction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:repeat-val is deprecated.  Use n3_sdk-msg:repeat instead.")
  (repeat m))
