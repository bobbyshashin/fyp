...
(cl:defmethod cl:initialize-instance :after ((m <A3GPS>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'A3GPS)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-msg:<A3GPS> is deprecated: use n3_sdk-msg:A3GPS instead.")))
...
(cl:defmethod height_above_sea-val ((m <A3GPS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:height_above_sea-val is deprecated.  Use n3_sdk-msg:height_above_sea instead.")
  (height_above_sea m))
