...
(cl:defmethod cl:initialize-instance :after ((m <TimeStamp>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TimeStamp)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-msg:<TimeStamp> is deprecated: use n3_sdk-msg:TimeStamp instead.")))
...
(cl:defmethod time_ns-val ((m <TimeStamp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:time_ns-val is deprecated.  Use n3_sdk-msg:time_ns instead.")
  (time_ns m))

(cl:ensure-generic-function 'sync_flag-val :lambda-list '(m))
(cl:defmethod sync_flag-val ((m <TimeStamp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:sync_flag-val is deprecated.  Use n3_sdk-msg:sync_flag instead.")
  (sync_flag m))
