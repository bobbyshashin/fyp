...
(cl:defclass <WaypointList> (roslisp-msg-protocol:ros-message)
  ((waypoint_list
    ...
    :type (cl:vector n3_sdk-msg:Waypoint)
   :initform (cl:make-array 0 :element-type 'n3_sdk-msg:Waypoint :initial-element (cl:make-instance 'n3_sdk-msg:Waypoint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <WaypointList>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WaypointList)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-msg:<WaypointList> is deprecated: use n3_sdk-msg:WaypointList instead.")))

(cl:ensure-generic-function 'waypoint_list-val :lambda-list '(m))
(cl:defmethod waypoint_list-val ((m <WaypointList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:waypoint_list-val is deprecated.  Use n3_sdk-msg:waypoint_list instead.")
  (waypoint_list m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <WaypointList>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'waypoint_list)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'n3_sdk-msg:Waypoint))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<WaypointList>)))
  ...
  (cl:format cl:nil "Waypoint[] waypoint_list~%~%================================================================================~%MSG: n3_sdk/Waypoint~%#latitude is in degree~%float64 latitude~%#longitude is in degree~%float64 longitude~%float32 altitude~%#heading is in [-180,180]~%int16 heading ~%#stay time is in second~%uint16 staytime~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'WaypointList)))
  "Returns full string definition for message of type 'WaypointList"
  (cl:format cl:nil "Waypoint[] waypoint_list~%~%================================================================================~%MSG: n3_sdk/Waypoint~%#latitude is in degree~%float64 latitude~%#longitude is in degree~%float64 longitude~%float32 altitude~%#heading is in [-180,180]~%int16 heading ~%#stay time is in second~%uint16 staytime~%~%~%"))
