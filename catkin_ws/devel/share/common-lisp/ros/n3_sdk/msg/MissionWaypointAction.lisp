...
(cl:defmethod cl:initialize-instance :after ((m <MissionWaypointAction>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionWaypointAction)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-msg:<MissionWaypointAction> is deprecated: use n3_sdk-msg:MissionWaypointAction instead.")))

(cl:ensure-generic-function 'action_repeat-val :lambda-list '(m))
(cl:defmethod action_repeat-val ((m <MissionWaypointAction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:action_repeat-val is deprecated.  Use n3_sdk-msg:action_repeat instead.")
  (action_repeat m))

(cl:ensure-generic-function 'command_list-val :lambda-list '(m))
(cl:defmethod command_list-val ((m <MissionWaypointAction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:command_list-val is deprecated.  Use n3_sdk-msg:command_list instead.")
  (command_list m))

(cl:ensure-generic-function 'command_parameter-val :lambda-list '(m))
(cl:defmethod command_parameter-val ((m <MissionWaypointAction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:command_parameter-val is deprecated.  Use n3_sdk-msg:command_parameter instead.")
  (command_parameter m))
