...
(cl:defmethod cl:initialize-instance :after ((m <MissionFollowmeTarget>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionFollowmeTarget)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-msg:<MissionFollowmeTarget> is deprecated: use n3_sdk-msg:MissionFollowmeTarget instead.")))
