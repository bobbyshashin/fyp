...
(cl:defclass <WaypointNavigationGoal> (roslisp-msg-protocol:ros-message)
  ((waypoint_list
    ...
    :type n3_sdk-msg:WaypointList
    :initform (cl:make-instance 'n3_sdk-msg:WaypointList)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <WaypointNavigationGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WaypointNavigationGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-msg:<WaypointNavigationGoal> is deprecated: use n3_sdk-msg:WaypointNavigationGoal instead.")))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<WaypointNavigationGoal>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%WaypointList waypoint_list~%~%================================================================================~%MSG: n3_sdk/WaypointList~%Waypoint[] waypoint_list~%~%================================================================================~%MSG: n3_sdk/Waypoint~%#latitude is in degree~%float64 latitude~%#longitude is in degree~%float64 longitude~%float32 altitude~%#heading is in [-180,180]~%int16 heading ~%#stay time is in second~%uint16 staytime~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'WaypointNavigationGoal)))
  "Returns full string definition for message of type 'WaypointNavigationGoal"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%WaypointList waypoint_list~%~%================================================================================~%MSG: n3_sdk/WaypointList~%Waypoint[] waypoint_list~%~%================================================================================~%MSG: n3_sdk/Waypoint~%#latitude is in degree~%float64 latitude~%#longitude is in degree~%float64 longitude~%float32 altitude~%#heading is in [-180,180]~%int16 heading ~%#stay time is in second~%uint16 staytime~%~%~%"))
