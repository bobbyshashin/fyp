...
(cl:defclass <MissionWaypoint> (roslisp-msg-protocol:ros-message)
  ((latitude
   ...
   (waypoint_action
    ...
    :type n3_sdk-msg:MissionWaypointAction
    :initform (cl:make-instance 'n3_sdk-msg:MissionWaypointAction)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MissionWaypoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionWaypoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-msg:<MissionWaypoint> is deprecated: use n3_sdk-msg:MissionWaypoint instead.")))

(cl:ensure-generic-function 'latitude-val :lambda-list '(m))
(cl:defmethod latitude-val ((m <MissionWaypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:latitude-val is deprecated.  Use n3_sdk-msg:latitude instead.")
  (latitude m))

(cl:ensure-generic-function 'longitude-val :lambda-list '(m))
(cl:defmethod longitude-val ((m <MissionWaypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:longitude-val is deprecated.  Use n3_sdk-msg:longitude instead.")
  (longitude m))

(cl:ensure-generic-function 'altitude-val :lambda-list '(m))
(cl:defmethod altitude-val ((m <MissionWaypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:altitude-val is deprecated.  Use n3_sdk-msg:altitude instead.")
  (altitude m))

(cl:ensure-generic-function 'damping_distance-val :lambda-list '(m))
(cl:defmethod damping_distance-val ((m <MissionWaypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:damping_distance-val is deprecated.  Use n3_sdk-msg:damping_distance instead.")
  (damping_distance m))

(cl:ensure-generic-function 'target_yaw-val :lambda-list '(m))
(cl:defmethod target_yaw-val ((m <MissionWaypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:target_yaw-val is deprecated.  Use n3_sdk-msg:target_yaw instead.")
  (target_yaw m))

(cl:ensure-generic-function 'target_gimbal_pitch-val :lambda-list '(m))
(cl:defmethod target_gimbal_pitch-val ((m <MissionWaypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:target_gimbal_pitch-val is deprecated.  Use n3_sdk-msg:target_gimbal_pitch instead.")
  (target_gimbal_pitch m))

(cl:ensure-generic-function 'turn_mode-val :lambda-list '(m))
(cl:defmethod turn_mode-val ((m <MissionWaypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:turn_mode-val is deprecated.  Use n3_sdk-msg:turn_mode instead.")
  (turn_mode m))

(cl:ensure-generic-function 'has_action-val :lambda-list '(m))
(cl:defmethod has_action-val ((m <MissionWaypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:has_action-val is deprecated.  Use n3_sdk-msg:has_action instead.")
  (has_action m))

(cl:ensure-generic-function 'action_time_limit-val :lambda-list '(m))
(cl:defmethod action_time_limit-val ((m <MissionWaypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:action_time_limit-val is deprecated.  Use n3_sdk-msg:action_time_limit instead.")
  (action_time_limit m))

(cl:ensure-generic-function 'waypoint_action-val :lambda-list '(m))
(cl:defmethod waypoint_action-val ((m <MissionWaypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:waypoint_action-val is deprecated.  Use n3_sdk-msg:waypoint_action instead.")
  (waypoint_action m))
