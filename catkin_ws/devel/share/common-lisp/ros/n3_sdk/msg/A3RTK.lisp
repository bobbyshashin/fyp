...
(cl:defmethod cl:initialize-instance :after ((m <A3RTK>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'A3RTK)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-msg:<A3RTK> is deprecated: use n3_sdk-msg:A3RTK instead.")))

(cl:ensure-generic-function 'date-val :lambda-list '(m))
(cl:defmethod date-val ((m <A3RTK>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:date-val is deprecated.  Use n3_sdk-msg:date instead.")
  (date m))

(cl:ensure-generic-function 'time-val :lambda-list '(m))
(cl:defmethod time-val ((m <A3RTK>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:time-val is deprecated.  Use n3_sdk-msg:time instead.")
  (time m))

(cl:ensure-generic-function 'longitude_RTK-val :lambda-list '(m))
(cl:defmethod longitude_RTK-val ((m <A3RTK>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:longitude_RTK-val is deprecated.  Use n3_sdk-msg:longitude_RTK instead.")
  (longitude_RTK m))

(cl:ensure-generic-function 'latitude_RTK-val :lambda-list '(m))
(cl:defmethod latitude_RTK-val ((m <A3RTK>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:latitude_RTK-val is deprecated.  Use n3_sdk-msg:latitude_RTK instead.")
  (latitude_RTK m))

(cl:ensure-generic-function 'height_above_sea_RTK-val :lambda-list '(m))
(cl:defmethod height_above_sea_RTK-val ((m <A3RTK>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:height_above_sea_RTK-val is deprecated.  Use n3_sdk-msg:height_above_sea_RTK instead.")
  (height_above_sea_RTK m))

(cl:ensure-generic-function 'velocity_north-val :lambda-list '(m))
(cl:defmethod velocity_north-val ((m <A3RTK>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:velocity_north-val is deprecated.  Use n3_sdk-msg:velocity_north instead.")
  (velocity_north m))

(cl:ensure-generic-function 'velocity_east-val :lambda-list '(m))
(cl:defmethod velocity_east-val ((m <A3RTK>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:velocity_east-val is deprecated.  Use n3_sdk-msg:velocity_east instead.")
  (velocity_east m))

(cl:ensure-generic-function 'velocity_ground-val :lambda-list '(m))
(cl:defmethod velocity_ground-val ((m <A3RTK>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:velocity_ground-val is deprecated.  Use n3_sdk-msg:velocity_ground instead.")
  (velocity_ground m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <A3RTK>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:yaw-val is deprecated.  Use n3_sdk-msg:yaw instead.")
  (yaw m))

(cl:ensure-generic-function 'position_flag-val :lambda-list '(m))
(cl:defmethod position_flag-val ((m <A3RTK>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:position_flag-val is deprecated.  Use n3_sdk-msg:position_flag instead.")
  (position_flag m))

(cl:ensure-generic-function 'yaw_flag-val :lambda-list '(m))
(cl:defmethod yaw_flag-val ((m <A3RTK>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:yaw_flag-val is deprecated.  Use n3_sdk-msg:yaw_flag instead.")
  (yaw_flag m))
