...
(cl:defclass <MissionWaypointTask> (roslisp-msg-protocol:ros-message)
  ((velocity_range
   ...
   (mission_waypoint
    ...
    :type (cl:vector n3_sdk-msg:MissionWaypoint)
   :initform (cl:make-array 0 :element-type 'n3_sdk-msg:MissionWaypoint :initial-element (cl:make-instance 'n3_sdk-msg:MissionWaypoint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MissionWaypointTask>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionWaypointTask)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-msg:<MissionWaypointTask> is deprecated: use n3_sdk-msg:MissionWaypointTask instead.")))

(cl:ensure-generic-function 'velocity_range-val :lambda-list '(m))
(cl:defmethod velocity_range-val ((m <MissionWaypointTask>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:velocity_range-val is deprecated.  Use n3_sdk-msg:velocity_range instead.")
  (velocity_range m))

(cl:ensure-generic-function 'idle_velocity-val :lambda-list '(m))
(cl:defmethod idle_velocity-val ((m <MissionWaypointTask>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:idle_velocity-val is deprecated.  Use n3_sdk-msg:idle_velocity instead.")
  (idle_velocity m))

(cl:ensure-generic-function 'action_on_finish-val :lambda-list '(m))
(cl:defmethod action_on_finish-val ((m <MissionWaypointTask>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:action_on_finish-val is deprecated.  Use n3_sdk-msg:action_on_finish instead.")
  (action_on_finish m))

(cl:ensure-generic-function 'mission_exec_times-val :lambda-list '(m))
(cl:defmethod mission_exec_times-val ((m <MissionWaypointTask>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:mission_exec_times-val is deprecated.  Use n3_sdk-msg:mission_exec_times instead.")
  (mission_exec_times m))

(cl:ensure-generic-function 'yaw_mode-val :lambda-list '(m))
(cl:defmethod yaw_mode-val ((m <MissionWaypointTask>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:yaw_mode-val is deprecated.  Use n3_sdk-msg:yaw_mode instead.")
  (yaw_mode m))

(cl:ensure-generic-function 'trace_mode-val :lambda-list '(m))
(cl:defmethod trace_mode-val ((m <MissionWaypointTask>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:trace_mode-val is deprecated.  Use n3_sdk-msg:trace_mode instead.")
  (trace_mode m))

(cl:ensure-generic-function 'action_on_rc_lost-val :lambda-list '(m))
(cl:defmethod action_on_rc_lost-val ((m <MissionWaypointTask>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:action_on_rc_lost-val is deprecated.  Use n3_sdk-msg:action_on_rc_lost instead.")
  (action_on_rc_lost m))

(cl:ensure-generic-function 'gimbal_pitch_mode-val :lambda-list '(m))
(cl:defmethod gimbal_pitch_mode-val ((m <MissionWaypointTask>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:gimbal_pitch_mode-val is deprecated.  Use n3_sdk-msg:gimbal_pitch_mode instead.")
  (gimbal_pitch_mode m))

(cl:ensure-generic-function 'mission_waypoint-val :lambda-list '(m))
(cl:defmethod mission_waypoint-val ((m <MissionWaypointTask>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:mission_waypoint-val is deprecated.  Use n3_sdk-msg:mission_waypoint instead.")
  (mission_waypoint m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MissionWaypointTask>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'mission_waypoint)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'n3_sdk-msg:MissionWaypoint))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MissionWaypointTask>)))
  ...
  (cl:format cl:nil "float32 velocity_range~%float32 idle_velocity~%uint8 action_on_finish~%uint8 mission_exec_times~%uint8 yaw_mode~%uint8 trace_mode~%uint8 action_on_rc_lost~%uint8 gimbal_pitch_mode~%MissionWaypoint[] mission_waypoint~%~%================================================================================~%MSG: n3_sdk/MissionWaypoint~%float64 latitude~%float64 longitude~%float32 altitude~%float32 damping_distance~%int16 target_yaw~%int16 target_gimbal_pitch~%uint8 turn_mode~%uint8 has_action~%uint16 action_time_limit~%MissionWaypointAction waypoint_action~%~%================================================================================~%MSG: n3_sdk/MissionWaypointAction~%uint8 action_repeat~%uint8[15] command_list~%int16[15] command_parameter~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MissionWaypointTask)))
  "Returns full string definition for message of type 'MissionWaypointTask"
  (cl:format cl:nil "float32 velocity_range~%float32 idle_velocity~%uint8 action_on_finish~%uint8 mission_exec_times~%uint8 yaw_mode~%uint8 trace_mode~%uint8 action_on_rc_lost~%uint8 gimbal_pitch_mode~%MissionWaypoint[] mission_waypoint~%~%================================================================================~%MSG: n3_sdk/MissionWaypoint~%float64 latitude~%float64 longitude~%float32 altitude~%float32 damping_distance~%int16 target_yaw~%int16 target_gimbal_pitch~%uint8 turn_mode~%uint8 has_action~%uint16 action_time_limit~%MissionWaypointAction waypoint_action~%~%================================================================================~%MSG: n3_sdk/MissionWaypointAction~%uint8 action_repeat~%uint8[15] command_list~%int16[15] command_parameter~%~%~%"))
