...
(cl:defmethod cl:initialize-instance :after ((m <MissionStatusFollowme>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MissionStatusFollowme)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-msg:<MissionStatusFollowme> is deprecated: use n3_sdk-msg:MissionStatusFollowme instead.")))
