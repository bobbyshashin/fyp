...
(cl:defmethod cl:initialize-instance :after ((m <FlightControlInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FlightControlInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name n3_sdk-msg:<FlightControlInfo> is deprecated: use n3_sdk-msg:FlightControlInfo instead.")))

(cl:ensure-generic-function 'control_mode-val :lambda-list '(m))
(cl:defmethod control_mode-val ((m <FlightControlInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:control_mode-val is deprecated.  Use n3_sdk-msg:control_mode instead.")
  (control_mode m))
...
(cl:defmethod cur_ctrl_dev_in_navi_mode-val ((m <FlightControlInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:cur_ctrl_dev_in_navi_mode-val is deprecated.  Use n3_sdk-msg:cur_ctrl_dev_in_navi_mode instead.")
...
(cl:defmethod serial_req_status-val ((m <FlightControlInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:serial_req_status-val is deprecated.  Use n3_sdk-msg:serial_req_status instead.")
  (serial_req_status m))

(cl:ensure-generic-function 'virtual_rc_status-val :lambda-list '(m))
(cl:defmethod virtual_rc_status-val ((m <FlightControlInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader n3_sdk-msg:virtual_rc_status-val is deprecated.  Use n3_sdk-msg:virtual_rc_status instead.")
  (virtual_rc_status m))
