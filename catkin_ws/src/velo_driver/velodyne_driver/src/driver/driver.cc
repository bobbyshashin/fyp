                               ...
                               ros::NodeHandle private_nh)
{
  ...
  private_nh.param("is_dual", config_.is_dual, false);
  ...
  if ((config_.model == "64E_S2") || 
    ...
    {
      packet_rate =  754;//781.25;             // 300000 / 384
      if(config_.is_dual){
  ...
  ROS_INFO("is dual output: %d ", config_.is_dual);
  ROS_INFO("packet rate is: %f ", packet_rate);
