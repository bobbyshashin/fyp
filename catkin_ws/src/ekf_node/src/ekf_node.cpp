...
void uav_vel_callback(const nav_msgs::Odometry::ConstPtr &msg)
{
...
void uav_rot_callback(const nav_msgs::Odometry::ConstPtr &msg)
{
  Quaterniond quater;
...
int main(int argc, char **argv)
{
  ...
  ros::Subscriber s1 = n.subscribe("uav_vel", 100, uav_vel_callback);
  ...
  ros::Subscriber s5 = n.subscribe("uav_rot", 100, uav_rot_callback);
