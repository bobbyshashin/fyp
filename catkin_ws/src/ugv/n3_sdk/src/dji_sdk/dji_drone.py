...
class DJIDrone:
    ...
    def init_subscribers(self):
        self.acceleration_subscriber = rospy.Subscriber("n3_sdk/acceleration", dji_sdk.msg.Acceleration, self.acceleration_subscriber_callback)
        self.attitude_quaternion_subscriber = rospy.Subscriber("n3_sdk/attitude_quaternion", dji_sdk.msg.AttitudeQuaternion, self.attitude_quaternion_subscriber_callback)
        self.compass_subscriber = rospy.Subscriber("n3_sdk/compass", dji_sdk.msg.Compass, self.compass_subscriber_callback)
        self.flight_control_info_subscriber = rospy.Subscriber("n3_sdk/flight_control_info", dji_sdk.msg.FlightControlInfo, self.flight_control_info_subscriber_callback)
        self.flight_status_subscriber = rospy.Subscriber("n3_sdk/flight_status", std_msgs.msg.UInt8, self.flight_status_subscriber_callback)
        self.gimbal_subscriber = rospy.Subscriber("n3_sdk/gimbal", dji_sdk.msg.Gimbal, self.gimbal_subscriber_callback)
        self.global_position_subscriber = rospy.Subscriber("n3_sdk/global_position", dji_sdk.msg.GlobalPosition, self.global_position_subscriber_callback)
        self.local_position_subscriber = rospy.Subscriber("n3_sdk/local_position", dji_sdk.msg.LocalPosition, self.local_position_subscriber_callback)
        self.power_status_subscriber = rospy.Subscriber("n3_sdk/power_status", dji_sdk.msg.PowerStatus, self.power_status_subscriber_callback)
        self.rc_channels_subscriber = rospy.Subscriber("n3_sdk/rc_channels", dji_sdk.msg.RCChannels, self.rc_channels_subscriber_callback)
        self.velocity_subscriber = rospy.Subscriber("n3_sdk/velocity", dji_sdk.msg.Velocity, self.velocity_subscriber_callback)
        self.activation_subscriber = rospy.Subscriber("n3_sdk/activation", std_msgs.msg.UInt8, self.activation_subscriber_callback)
        self.odometry_subscriber = rospy.Subscriber("n3_sdk/odometry", nav_msgs.msg.Odometry, self.odometry_subscriber_callback)
        self.time_stamp_subscriber = rospy.Subscriber("n3_sdk/time_stamp", dji_sdk.msg.TimeStamp, self.time_stamp_subscriber_callback)

    def init_services(self):
        rospy.wait_for_service("n3_sdk/attitude_control")
        rospy.wait_for_service("n3_sdk/camera_action_control")
        rospy.wait_for_service("n3_sdk/drone_task_control")
        rospy.wait_for_service("n3_sdk/gimbal_angle_control")
        rospy.wait_for_service("n3_sdk/gimbal_speed_control")
        rospy.wait_for_service("n3_sdk/global_position_control")
        rospy.wait_for_service("n3_sdk/local_position_control")
        rospy.wait_for_service("n3_sdk/sdk_permission_control")
        rospy.wait_for_service("n3_sdk/velocity_control")
        rospy.wait_for_service("n3_sdk/drone_arm_control")
        rospy.wait_for_service("n3_sdk/virtual_rc_enable_control")
        rospy.wait_for_service("n3_sdk/virtual_rc_data_control")
        rospy.wait_for_service("n3_sdk/sync_flag_control")

        self.attitude_control_service = rospy.ServiceProxy("n3_sdk/attitude_control", dji_sdk.srv.AttitudeControl)
        self.camera_action_control_service = rospy.ServiceProxy("n3_sdk/camera_action_control", dji_sdk.srv.CameraActionControl)
        self.drone_task_control_service = rospy.ServiceProxy("n3_sdk/drone_task_control", dji_sdk.srv.DroneTaskControl)
        self.gimbal_angle_control_service = rospy.ServiceProxy("n3_sdk/gimbal_angle_control", dji_sdk.srv.GimbalAngleControl)
        self.gimbal_speed_control_service = rospy.ServiceProxy("n3_sdk/gimbal_speed_control", dji_sdk.srv.GimbalSpeedControl)
        self.global_position_control_service = rospy.ServiceProxy("n3_sdk/global_position_control", dji_sdk.srv.GlobalPositionControl)
        self.local_position_control_service = rospy.ServiceProxy("n3_sdk/local_position_control", dji_sdk.srv.LocalPositionControl)
        self.sdk_permission_control_service = rospy.ServiceProxy("n3_sdk/sdk_permission_control", dji_sdk.srv.SDKPermissionControl)
        self.velocity_control_service = rospy.ServiceProxy("n3_sdk/velocity_control", dji_sdk.srv.VelocityControl)
        self.drone_arm_service = rospy.ServiceProxy("n3_sdk/drone_arm_control", dji_sdk.srv.DroneArmControl)
        self.drone_vrc_enable_service = rospy.ServiceProxy("n3_sdk/virtual_rc_enable_control", dji_sdk.srv.VirtualRCEnableControl)
        self.drone_vrc_data_service = rospy.ServiceProxy("n3_sdk/virtual_rc_data_control", dji_sdk.srv.VirtualRCDataControl)
        self.sync_timestamp_service = rospy.ServiceProxy("n3_sdk/sync_flag_control", dji_sdk.srv.SyncFlagControl)

    def init_actions(self):
        self.local_position_navigation_action_client = actionlib.SimpleActionClient("n3_sdk/local_position_navigation_action", dji_sdk.msg.LocalPositionNavigationAction)
        self.local_position_navigation_action_client.wait_for_server()
        self.global_position_navigation_action_client = actionlib.SimpleActionClient("n3_sdk/global_position_navigation_action", dji_sdk.msg.GlobalPositionNavigationAction)
        self.global_position_navigation_action_client.wait_for_server()
        self.waypoint_navigation_action_client = actionlib.SimpleActionClient("n3_sdk/waypoint_navigation_action", dji_sdk.msg.WaypointNavigationAction)
