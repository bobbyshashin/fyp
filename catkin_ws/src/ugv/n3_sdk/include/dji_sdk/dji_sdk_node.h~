...
//Publishers:
    ...
    {
        // start ros publisher
	activation_publisher = nh.advertise<std_msgs::UInt8>("n3_sdk/activation", 10);
        acceleration_publisher = nh.advertise<dji_sdk::Acceleration>("n3_sdk/acceleration", 10);
        attitude_quaternion_publisher = nh.advertise<dji_sdk::AttitudeQuaternion>("n3_sdk/attitude_quaternion", 10);
        compass_publisher = nh.advertise<dji_sdk::Compass>("n3_sdk/compass", 10);
        flight_control_info_publisher = nh.advertise<dji_sdk::FlightControlInfo>("n3_sdk/flight_control_info", 10);
        flight_status_publisher = nh.advertise<std_msgs::UInt8>("n3_sdk/flight_status", 10);
        gimbal_publisher = nh.advertise<dji_sdk::Gimbal>("n3_sdk/gimbal", 10);
        global_position_publisher = nh.advertise<dji_sdk::GlobalPosition>("n3_sdk/global_position", 10);
        local_position_publisher = nh.advertise<dji_sdk::LocalPosition>("n3_sdk/local_position", 10);
        power_status_publisher = nh.advertise<dji_sdk::PowerStatus>("n3_sdk/power_status", 10);
        rc_channels_publisher = nh.advertise<dji_sdk::RCChannels>("n3_sdk/rc_channels", 10);
        velocity_publisher = nh.advertise<dji_sdk::Velocity>("n3_sdk/velocity", 10);
        odometry_publisher = nh.advertise<nav_msgs::Odometry>("n3_sdk/odometry",10);
        time_stamp_publisher = nh.advertise<dji_sdk::TimeStamp>("n3_sdk/time_stamp", 10);
	data_received_from_remote_device_publisher = nh.advertise<dji_sdk::TransparentTransmissionData>("n3_sdk/data_received_from_remote_device",10);
        orientation_publisher = nh.advertise<geometry_msgs::Vector3>("n3_sdk/orientation",10);
	//TODO: Identify the drone version first	
	A3_GPS_info_publisher = nh.advertise<dji_sdk::A3GPS>("n3_sdk/A3_GPS", 10);
	A3_RTK_info_publisher = nh.advertise<dji_sdk::A3RTK>("n3_sdk/A3_RTK", 10);
